...
const WorkExperience = () => {
  const workExperiences = [{
    ...
    startDate: '11/2021',
    endDate: 'Present',
    description: 'Flick is a social media platform. I Implemented complex React user experiences, delivering intuitive and seamless interfaces. I integrated an AI Social Marketing Assistant powered by OpenAI to overcome users creative blocks and enhance marketing strategies.',
  },
  {
    position: 'Full-Stack Engineer',
    company: 'One Beyond',
  ...
  },
  {
    ...
    startDate: '01/2018',
    endDate: '03/2020',
    description: '1millionbot is a chatbot platform. I refactored the main JS scripts to increase by 30% the data obtained from leads. I developed the company dashboard to speed up the NLP chatbot training by 50%. I designed the company architecture & integrated its infrastructure into Google Cloud Platform.',
  },
  ]
    ...
    <>
      {workExperiences.map((workExperience) => (
        <ResumeItem key={workExperience.company}>
          <ResumeItemHeader>
            <ResumeItemTitle><>{workExperience.position} at <a
            ...
            <div>
              <small>{workExperience.location} • {workExperience.startDate} - {workExperience.endDate}</small>
            </div>
          </ResumeItemHeader>
