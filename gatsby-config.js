...
module.exports = {
  ...
  siteMetadata: {
    ...
    googleSiteVerification: process.env.GOOGLE_SITE_VERIFICATION || 'Add the Google Site Verification',
    author: {
      name: `Ramon Morcillo`,
  ...
  plugins: [
    ...
    },
    {
      ...
      options: {
        trackingId: process.env.GOOGLE_ANALYTICS_TRACKING_ID || 'Add the Google Analytics Tracking ID',
      }
    },
